			...
			<div id="inputArea">
				<div id="inputAreaInner">
					<form method="post" enctype="multipart/form-data" class="basicInputField">
						...
						<input type="text" name="name" placeholder="Название проекта" value="<?=$project['name']?>" required/>
						<textarea placeholder="Описание" name="description" required><?=$project['description']?></textarea>
